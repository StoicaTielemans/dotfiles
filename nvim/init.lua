...
-- = "a" Enable mouse mode, can be useful for resizing splits for example!
vim.opt.mouse = ''
...
-- keymaps for nvim tree and oil
vim.keymap.set('n', '<leader>-', ':NvimTreeFindFileToggle!<cr>')
vim.keymap.set('n', '-', '<CMD>Oil --float <CR>', { desc = 'Open parent directory' })
-- start undotree
vim.keymap.set('n', '<leader>u', vim.cmd.UndotreeToggle, { desc = ' Start undotree' })
-- save
...
require('lazy').setup({
  ...
  -- the kickstart repo, not just copy pasted the
